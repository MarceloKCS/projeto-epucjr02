        ...
        <script type="text/javascript">
            ...
            function realizaBuscaDeReunioes(parametroBusca, paginaSelecionada){
                 $.getJSON("frontcontrollerajax?acao=ajax_get_reuniaosearch&parametroBusca=" + parametroBusca + "&paginaCorrente=" + paginaSelecionada, {ajax: 'true'}, function(resultadoBuscaArray){
                    ...
                    var countVisual = 0;
                    var tabela = '<tr> <th>Data</th>  <th>Hora</th> <th>Local</th> <th>Editar</th>  <th>Excluir</th> <th>Reunião</th> </tr>';
                    for (var i = 1; i < resultadoBuscaArray.length; i++) {
                        ...
                        tabela += " <td> <a href=\"Controller?acao=iniciar_reuniao&idReuniao=" + resultadoBuscaArray[i].id + "\"> <img src=\"imagens/reuniao.png\" width=\"18\" height=\"18\" title=\"Iniciar Reunião\"/></a></td>";
                        tabela += "</tr>";
        ...
        <div id="all">
                ...
                <div id="conteudo">
                    <ul id="tabmenu">
                            ...
                            <li id="liReunioes" class="tab_on"><a href="Controller?acao=busca_loader&pagina_busca=buscar_reuniao">Reunião</a></li>
                    </ul>
                        ...
                        <div id="buscarReunioes">
                            <form name="buscarReuniao" method="post" action="Controller" id="buscarReuniao">
                                ...
                                <div class="buscar_reuniao_submit">
                                    <input type="button" id="buscar_reuniao_submit" name="acao" value="Buscar Reunião"/>
                                </div>
                            </form>
