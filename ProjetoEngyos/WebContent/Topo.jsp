...
<p><a href="Controller?acao=page_loader&page_corrente=pagina_administrativa">Administrativo</a></p>
<p><a href="Controller?acao=administrador_editformload&cpfAdministrador=<% out.print(request.getSession().getAttribute(UserSessionControl.ID_USUARIO)); %>">Alterar dados</a></p>
