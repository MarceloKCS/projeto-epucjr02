...
//		reuniao.setListaDePresenca(new PresencaObreiro());
//
...
//		DataAccessObjectManager dataAccessObjectManager = new DataAccessObjectManager();
//		PresencaObreiro presenca = (PresencaObreiro) dataAccessObjectManager.obterPresenca(1);
//		List<PresencaObreiro> listaDeObreiro = presenca.get
//
