 ...
 */
public class ObreiroCadastrarCongregacaoFindAllServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private BuscaAvancada buscaAvancada;
	private List<Congregacao> congregacao;
       

    public ObreiroCadastrarCongregacaoFindAllServlet() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		view = request.getRequestDispatcher("CadastrarObreiro.jsp");
